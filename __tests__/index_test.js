...
describe('snapshots', () => {
    const CMDS = [
        ...
        'docker run -d --name plex --net=host -e TZ="<timezone>" -e PLEX_CLAIM="<claimToken>" -v <path/to/plex/database>:/config -v <path/to/transcode/temp>:/transcode -v <path/to/media>:/data plexinc/pms-docker',
        ...
        'docker run -p 80:80 --pid="host" --ulimit nofile=1234:1234 --name webserver nginx:latest'
    ];
