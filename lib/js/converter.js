require('yamljs/dist/yaml.min.js');
...
const optionMap = {
    ...
    'name': OptionType.Array('cgroup_parent'),
...
export default input => {
    ...
    const service = tokens[tokens.length - 1];
    ...
    result.services[service].image = service;
    ...
    return YAML.stringify(result, 9, 4);
};
